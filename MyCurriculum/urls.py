...
urlpatterns = [
    ...
    path("course/<str:course_code>/session/<str:session_id>", views.session.session_view, name='session-view'),
    path("course/<str:course_code>/enroll", views.enrollment.enroll_view, name='enroll-view'),
    path("course/<str:course_code>/unroll", views.enrollment.unroll_view, name='unroll-view'),
